...
namespace Func_forex_Ravi_Oanda_Api.Maps
{
    ...
    {
        public static List<FxCurrencyTable> TransformQuarterHourDataToFxCurrentTable(this PricingModel instrumentlatestPrices, Account account, List<FxCurrencyTable> historicalPrices)
        {
